<script>
  ...
  import createFile from '../assets/create-file.gif';
  import openFile from '../assets/open-file.gif';
</script>
  ...
  <section class="carousel" aria-label="Gallery">
    <ol class="carousel__viewport">
      ...
      <li
        ...
        tabindex="0"
        class="carousel__slide"
        style="background-image: url('{lightMode}')"
      >
        <div class="carousel__snapper" />
      ...
      <li
        ...
        tabindex="0"
        class="carousel__slide"
        style="background-image: url('{createFile}')"
      >
        <div class="carousel__snapper" />
      ...
      <li
        ...
        tabindex="0"
        class="carousel__slide"
        style="background-image: url('{openFile}')"
      >
        <div class="carousel__snapper" />
